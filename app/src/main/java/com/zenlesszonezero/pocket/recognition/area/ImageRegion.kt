package com.zenlesszonezero.pocket.recognition.area

import android.util.Log
import com.zenlesszonezero.pocket.recognition.ColorConversion
import com.zenlesszonezero.pocket.recognition.IntRect
import com.zenlesszonezero.pocket.recognition.OcrText
import com.zenlesszonezero.pocket.recognition.RecognitionObject
import com.zenlesszonezero.pocket.recognition.RecognitionTypes
...
import com.zenlesszonezero.pocket.recognition.opencv.MatchTemplateHelper
...
open class ImageRegion(
    ...
    private fun effectiveMask(mask: Mat?, effectiveTemplate: Mat): Mat? {
        ...
        return MatOps.resize(
            mask,
            com.zenlesszonezero.pocket.recognition.IntSize(effectiveTemplate.cols(), effectiveTemplate.rows()),
